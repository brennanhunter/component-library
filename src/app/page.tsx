...
import { LogoAdaptiveToBackground } from '../components/LogoAdaptiveToBackground';
import { BGChangeSections } from '../components/BGChangeSections';
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen">
      <LogoAdaptiveToBackground />
      
      {/* Centered content section */}
      <div className="flex flex-col items-center justify-center bg-gray-100 space-y-8 h-screen">
